...
def multiplechoicequestion(): #---------------------------------------------------------\<- that didn't work
    ...
    while errorcount != 3:                                                             #|
        ...
        useranswer = int(input("What is: {} + {}? ".format(questionbuffer[0],questionbuffer))) # find a way to specify the operator and facilitate larger numebr of integers
...
#if len(questionbuffer) % 2 == 0: (Even)
#	while questionbuffer[0+count+1] (Even number) != questionbuffer[-1]:
#		questionpairs.append(questionbuffer[0+count], questionbuffer[0+count+1])
#		count += 1
#	else:
#		break
#
#else: (Odd)
#	while questionbuffer[0+count] (Odd number) == questionbuffer[-1]:
#		questionpairs.append(questionbuffer[0+count], questionbuffer[0+count+1])
#		count += 1		
#	else:
#		questionpairs.append(questionbuffer[0+count])
